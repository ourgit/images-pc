<template>
  <div class="upload-wrap" :class="{ maxHidden: isMaxHidden }">
    ...
    <el-upload class="upload-box" :headers="headers" action="/v2/shop/upload/"
      :style="{ width: width + 'px', height: height + 'px' }" accept=".jpg,.jpeg,.png,.gif" :show-file-list="false"
      :multiple="true" :limit="limit" :on-success="handleSuccess" :before-upload="beforeUpload">
